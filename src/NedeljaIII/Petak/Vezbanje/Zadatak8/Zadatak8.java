...
Napisati sledece metode:
	...
	sa nekim od tih automobila i vodja puta, i onda prijavite neke od osoba na neka od putovanja,
	i onda pozovite i metodu za racunanje koliko je vremena potrebno da se stigne pri odredjenoj brzini.
         */
        Grad grad1 = new Grad("Pariz", 5000000, "Francuska");
        Automobil automobil1 = new Automobil("BMW", 2021, 100000);
        Osoba osoba1 = new Osoba("Aleksandra Zivkovic");
        Putovanje putovanje1 = new Putovanje(grad1, automobil1, 538);
        System.out.println(putovanje1.vratiVremeKojeJePotrebno(120));
        putovanje1.prijava(osoba1);
        System.out.println( putovanje1.getPrijavljeneOsobe());
        putovanje1.odjava(osoba1);
        System.out.println( putovanje1.getPrijavljeneOsobe());
